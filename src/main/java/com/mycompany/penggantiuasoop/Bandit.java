...
class Bandit extends Enemy{
    ...
    public void stealGold() {
        System.out.println(name +" menggunakan Steal Gold"); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    @Override
    ...
    public void basicDefend() {
        System.out.println(name +" menggunakan Defend"); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    @Override
    public void counter() {
