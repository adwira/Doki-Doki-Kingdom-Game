...
class Imp extends Enemy{
    ...
    public void strikeAttack() {
        System.out.println(name +" menggunakan skill Strike Attack"); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    @Override
    ...
    public void fireball() {
        System.out.println(name +" menggunakan FireBall"); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    @Override
    ...
    public void basicDefend() {
        System.out.println(name +" menggunakan BAsic Defend"); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    @Override
    public void counter() {
